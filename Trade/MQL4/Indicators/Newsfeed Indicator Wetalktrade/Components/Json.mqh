...
class JSONArray : public JSONValue {
    ...
    public:
        ...
        string toString() {
           string ks = "[";
           if (_size > 0) {
               ks = StringConcatenate(ks,_array[0].toString());
               for(int i = 1 ; i< _size ; i++ ) {
                  ks = StringConcatenate(ks,",",_array[i].toString());
               }
           }
           ks = ks + "]";
           return ks; 
    ...
    public:
        ...
        JSONValue *parseValue() 
        {
            ...
            if (_in[_pos] == '[')  {
                ...
                string ks = parseString();
                ret = (JSONValue*)new JSONString(ks);
                ...
                if (isDoubleDigit(_in[i])) {
                   ...
                   string lks = StringSubstr(_instr,_pos,i-_pos);
                    double d = sign * StringToDouble(lks);
...
void json_demo() 
{
    string ks = "{ \"firstName\": \"John\", \"lastName\": \"Smith\", \"age\": 25, \"address\": { \"streetAddress\": \"21 2nd Street\", \"city\": \"New York\", \"state\": \"NY\", \"postalCode\": \"10021\" }, \"phoneNumber\": [ { \"type\": \"home\", \"number\": \"212 555-1234\" }, { \"type\": \"fax\", \"number\": \"646 555-4567\" } ], \"gender\":{ \"type\":\"male\" }  }";
    JSONParser *parser = new JSONParser();
    JSONValue *jv = parser.parse(ks);
    Print("json:");
    if (jv == NULL) {
        ...
        if (jv.isObject()) {
            ...
            if (jo.getString("firstName",ks) ) Print("firstName = "+ks);
