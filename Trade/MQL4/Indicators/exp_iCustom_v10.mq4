...
/*
   ...
   Режим 6 для _O_Mode и _C_Mode - смена цвета с пересечением через 0 в индикаторах в отдельном окне. В некотрых случаях для
   таких вариантов не подходит режим 5, можно попробовать режим 6.
*/
...
extern string     s0                         = "==== Индикатор для открытия (Mode: 1 - стрелки, 2 - главная и сигнальная, 3 - линия и уровни, 4 - экстремум, 5 - смена цвета при значении больше 0, 6 - смена цвета через ноль) ====";
...
extern int        _OС_Mode                   = 1;        // 1-закрытие по стоплосс и тейкпрофит, 2-перед открытием закрываются противоположные ордера по сигналам открытия индикатора _O_, 3-используются сигналы закрытия индикатора _C_
extern string     s2                         = "==== Индикатор для закрытия (Mode: 1 - стрелки, 2 - главная и сигнальная, 3 линия и уровни, 4 экстремум, 5 - смена цвета при значении больше 0, 6 - смена цвета через ноль) ====";
