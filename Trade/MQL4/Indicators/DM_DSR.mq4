...
int start() {
   ...
   for (int li_8 = 0; li_8 < li_4; li_8++) g_ibuf_112[li_8] = (High[iHighest(NULL, 0, MODE_HIGH, 3, li_8)] + Low[iLowest(NULL, 0, MODE_LOW, 3, li_8)] + Close[li_8]) / 3.0;
   for (li_8 = 0; li_8 < li_4; li_8++) g_ibuf_116[li_8] = iMAOnArray(g_ibuf_112, Bars, 25, 0, MODE_SMA, li_8);
   for (li_8 = li_4 - 1; li_8 >= 0; li_8--) {
      if (g_ibuf_112[li_8 + 1] > g_ibuf_116[li_8 + 1] && g_ibuf_112[li_8] < g_ibuf_116[li_8]) g_ibuf_104[li_8] = High[iHighest(NULL, 0, MODE_HIGH, 28, li_8)];
      else g_ibuf_104[li_8] = g_ibuf_104[li_8 + 1];
   }
   for (li_8 = li_4 - 1; li_8 >= 0; li_8--) {
      if (g_ibuf_112[li_8 + 1] < g_ibuf_116[li_8 + 1] && g_ibuf_112[li_8] > g_ibuf_116[li_8]) g_ibuf_100[li_8] = Low[iLowest(NULL, 0, MODE_LOW, 28, li_8)];
