...
//---- Pivot Lines
   if (pivots==true)
   {
      ...
      ObjectSetText("R1 label", " R1", 10, "Arial", White);
      }
      else
      {
      ...
      ObjectSetText("R2 label", " R2", 10, "Arial", White);
      }
      else
      {
      ...
      ObjectSetText("R3 label", " R3", 10, "Arial", White);
      }
      else
      {
      ...
      ObjectSetText("P label", "Pivot", 15, "Arial", White);
      }
      else
      {
      ...
      ObjectSetText("S1 label", "S1", 10, "Arial", White);
      }
      else
      {
      ...
      ObjectSetText("S2 label", "S2", 10, "Arial", White);
      }
      else
      {
      ...
      ObjectSetText("S3 label", "S3", 10, "Arial", White);
      }
      else
      {
...
//---  Draw  Pivot lines on chart
      ...
      ObjectSet("P line", OBJPROP_COLOR, White);
      }
      else
      {
...
//----- Camarilla Lines
   ...
   if (camarilla==true)
   {
      ...
      ObjectSetText("H4 label", " H4", 10, "Arial", White);
      }
      else
      {
      ...
      ObjectSetText("H3 label", " H3", 10, "Arial", White);
      }
      else
      {
      ...
      ObjectSetText("L3 label", " L3", 10, "Arial", White);
      }
      else
      {
      ...
      ObjectSetText("L4 label", " L4", 10, "Arial", White);
      }
      else
      {
...
//------ Midpoints Pivots 
   ...
   if (midpivots==true)
   {
      ...
      ObjectSetText("M5 label", " M5", 10, "Arial", White);
      }
      else
      {
      ...
      ObjectSetText("M4 label", " M4", 10, "Arial", White);
      }
      else
      {
      ...
      ObjectSetText("M3 label", " M3", 10, "Arial", White);
      }
      else
      {
      ...
      ObjectSetText("M2 label", " M2", 10, "Arial", White);
      }
      else
      {
      ...
      ObjectSetText("M1 label", " M1", 10, "Arial", White);
      }
      else
      {
      ...
      ObjectSetText("M0 label", " M0", 10, "Arial", White);
      }
      else
      {
