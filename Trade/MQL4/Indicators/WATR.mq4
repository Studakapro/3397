...
bool TrendUp(int i)
{
    ...
    //return(ExtMapBufferUp[i+1] != EMPTY_VALUE);
}
...
int start()
{
    ...
    for(int i = limit; i >= 0; i--)
    {
        ...
        /* Comment("AntiTrendBar: ", AntiTrendBar(i), "\n", 
                "ExtMapBufferUp[i]: ", ExtMapBufferUp[i], "\n", 
                "ExtMapBufferUp[i+1]: ", ExtMapBufferUp[i+1], "\n",  
                "ExtMapBufferDown[i]: ", ExtMapBufferDown[i], "\n", 
                "ExtMapBufferDown[i+1]: ", ExtMapBufferDown[i+1], "\n", 
                "TrendUp: ", TrendUp(i)); */
    }
