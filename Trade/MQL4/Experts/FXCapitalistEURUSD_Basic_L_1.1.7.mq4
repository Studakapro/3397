...
int init() {
   ...
   if (MqlLock_50B822E3_47_iIi1Ii1i11(WindowHandle(Symbol(), Period())) == 1) {
      ...
      g_symbol_164 = f0_1("EURUSD");
      Print("Symbol : ", g_symbol_164);
...
void start() {
   ...
   if (!(gi_76)) gi_76 = MqlLock_50B822E3_47_IIIi11111i(WindowHandle(Symbol(), Period()));
   ...
   if (MqlLock_50B822E3_47_i1111I1IiI(li_4)) {
      f0_0(5);
      Print("Lots ", g_lots_236, "SL", gda_204[1] - gd_108 * gd_176, "Prix ", gda_204[1]);
      li_0 = MqlLock_50B822E3_47_I11IIIii1i(OrderSend(g_symbol_164, OP_BUYSTOP, g_lots_236, gda_204[1], 2, gda_204[1] - gd_108 * gd_176, gda_204[1] +
         gd_100 * gd_176, "FXC", g_magic_192), gda_204[1], g_symbol_164, g_lots_236, gd_108, gd_176, gd_100, g_magic_192);
   }
   if (MqlLock_50B822E3_47_1iiiiI11I1(li_8)) {
      f0_0(4);
      Print("Lots ", g_lots_236, "SL", gda_208[1] + gd_108 * gd_176, "Prix ", gda_208[1]);
      li_0 = MqlLock_50B822E3_47_I1iII1Iii1(OrderSend(g_symbol_164, MqlLock_50B822E3_47_iIii1IiIii(), g_lots_236, gda_208[1], 2, gda_208[1] + gd_108 * gd_176, gda_208[1] - gd_100 * gd_176,
         "FXC", g_magic_196), gda_208[1], g_symbol_164, g_lots_236, gd_108, gd_176, gd_100, g_magic_196);
   }
...
void f0_2() {
   ...
   for (int pos_4 = 0; pos_4 < OrdersTotal(); pos_4++) {
      if (MqlLock_50B822E3_47_IiiI11i111(OrderSelect(pos_4, 0), OrderSymbol(), pos_4, g_symbol_164)) {
         li_0++;
...
void f0_3() {
   ...
   if (MqlLock_50B822E3_47_i1I11iiI1I(gi_132)) {
      while (li_44 < OrdersHistoryTotal() - 1) {
         ...
         if (OrderSelect(OrdersHistoryTotal() - 1 - li_44, 0, MqlLock_50B822E3_47_iIIii111ii()) && OrderMagicNumber() == g_magic_192 || OrderMagicNumber() == g_magic_196 &&
            OrderSymbol() == g_symbol_164 && OrderType() != OP_BUYSTOP && OrderType() != MqlLock_50B822E3_47_i1i1iiii11()) {
            li_40++;
   ...
   if (MqlLock_50B822E3_47_I11III11ii(Lots)) {
      ...
      if (!MoneyManagement) g_lots_236 = MqlLock_50B822E3_47_iIIIii11Ii(ld_8);
      else {
   ...
   if (MqlLock_50B822E3_47_1ii1iIiii1(gi_116)) {
      while (li_44 < OrdersHistoryTotal() - 1) {
         ...
         if (OrderSelect(OrdersHistoryTotal() - 1 - li_44, MqlLock_50B822E3_47_I11I1I11I1(), MqlLock_50B822E3_47_i1i11Ii1ii()) && OrderMagicNumber() == g_magic_192 || OrderMagicNumber() == g_magic_196 &&
            OrderSymbol() == g_symbol_164 && OrderType() != OP_BUYSTOP && OrderType() != MqlLock_50B822E3_47_1IiI1I11iI()) {
            li_40++;
...
string f0_1(string as_0) {
   ...
   string ls_40;
   string ls_48 = 0;
   string name_24 = "symbols.raw";
   int file_8 = FileOpenHistory(name_24, FILE_BIN|FILE_READ);
   if (file_8<1) {
      Print("HTML Report generator - Unable to open file" + name_24 + ", the last error is: ", GetLastError());
      return (-1);
   }
   int li_20 = FileSize(file_8);
   for (int li_12 = 0; li_12 < li_20; li_12++) {
      ls_32 = FileReadString(file_8, 12);
      ls_40 = FileReadString(file_8, 75);
      FileSeek(file_8, 1849, SEEK_CUR);
      if (StringFind(ls_32, as_0) >= 0 && StringLen(ls_32) > StringLen(ls_48) && StringFind(ls_32,"ST") == -1 && StringFind(ls_32, "Ask") == -1 && StringFind(ls_32,"Bid") == -1 && StringFind(ls_32, "Avg") == -1) ls_48 = MqlLock_50B822E3_47_IIIi1i1i1i(ls_32);
   }
   FileClose(file_8);
   return (ls_48);
}